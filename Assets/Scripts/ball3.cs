...
public class ball3 : MonoBehaviour
{
    ...
    void Start()
    {
        transform.localPosition = new Vector3(5, 2, 18);
    ...
    void Update()
    {
        ...
        if (!GameObject.Find("MapImageTarget3").GetComponent<mapBehavior3>().work && rb.velocity != new Vector3(0.0f, 0.0f, 0.0f))
        {
            oldVelocity = rb.velocity;
            rb.velocity = new Vector3(0.0f, 0.0f, 0.0f);
        }
        //else works normal
        else if (GameObject.Find("MapImageTarget3").GetComponent<mapBehavior3>().work)
        {
